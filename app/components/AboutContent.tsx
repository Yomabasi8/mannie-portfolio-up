    ...
    <section className="bg-brand-bg px-8 sm:px-6 lg:px-8 py-16 sm:py-24">
      <div className="max-w-[1100px] mx-auto">
        ...
        <p className="font-poppins text-base sm:text-lg lg:text-xl text-brand-black-dark text-center max-w-3xl mx-auto mt-4 leading-relaxed">
          <span className="font-bold uppercase">Producer | Audio Editor | Manager | Podcaster</span>
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mt-8 sm:mt-12">
          ...
          <div>
            ...
            <p className="font-poppins text-base sm:text-lg text-brand-black-light leading-relaxed mt-5">
              ...
              chasing the thrill of telling stories and having real conversations without ever showing my face.
            </p>
            <p className="font-poppins text-base sm:text-lg text-brand-black-light leading-relaxed mt-5">
              That passion for audio storytelling is what eventually pulled me into the craft of production.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mt-16 sm:mt-20">
          <div className="lg:order-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              {/* LinkedIn */}
              <a
                href="https://linkedin.com/in/emmanuel-okonko-7091aa359"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-10 h-10 flex items-center justify-center rounded-lg border-2 border-brand-black-dark bg-white shadow-[2px_2px_0px_0px_#060606] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[1px_1px_0px_0px_#060606] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all duration-150"
              >
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/mannie.so/"
                target="_blank"
                rel="noopener noreferrer"
